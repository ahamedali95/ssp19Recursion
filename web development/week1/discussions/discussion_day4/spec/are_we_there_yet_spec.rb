RSpec.describe "Person" do
  ...
  context "Test RSPEC" do
   describe "#are_we_there_yet?" do
     it "Prints are we there yet 4 times" do
       # expect {are_we_there_yet?}.to output("are we there yet?").to_stdout.4.times
       expect($stdout).to receive(:puts).with("are we there yet?").exactly(4).times
       are_we_there_yet?
     end
   end
 end
